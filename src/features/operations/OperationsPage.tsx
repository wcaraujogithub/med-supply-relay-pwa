...
//       setOperationMessage(
//         result.expiredCount === 0 ? t('reservations.expireNone')
...
//               >
//                {isLoadingMatches ? t('filters.loading') : t('filters.updateMatches')}
//               </button>
...
//             <div>
//               <strong>{formatQuantity(totalSuggested,language)}</strong>
...
//             <span>
//              {t('matches.page', { current: currentPage, total: totalPages })}
//             </span>
...
//                       <strong>
//                         {formatQuantity(match.demandQuantity, language)} {match.unit}
//                       </strong>
//                     </div>
...
//                       <strong>
//                         {formatQuantity(totalQuantity, language)} {match.unit}
//                       </strong>
//                     </div>
...
//                       <strong>
//                         {formatQuantity(reservedQuantity, language)} {match.unit}
//                       </strong>
//                     </div>
...
//                       <strong>
//                         {formatQuantity(availableQuantity, language)} {match.unit}
//                       </strong>
//                     </div>
...
//                       <strong>
//                         {formatQuantity(match.suggestedQuantity, language)} {match.unit}
//                       </strong>
//                     </div>
//                   </div>
...
//                       {t('matches.expires', { value: match.supplyExpiresOn })}                 
//                     </p>
//                   )}
...
//                     >                 
//                         {availableQuantity > 0 ? t('matches.reservePickup') : t('matches.noFreeStock')}
//                     </button>
...
//                 <span>
//                   {formatQuantity(reservation.reservedQuantity,language)} {reservation.unit}
//                 </span>
//                 <small>
